...
class PyramidFlowMatchEulerDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        print("start_sigmas", self.start_sigmas)
        print("end_sigmas", self.end_sigmas)
        print("ori_start_sigmas", self.ori_start_sigmas)
        print("timestep_ratios", self.timestep_ratios)
        print("timesteps_per_stage", self.timesteps_per_stage)
