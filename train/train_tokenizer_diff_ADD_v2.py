...
from modelling.tokenizer_ADD_v2 import VQ_models
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for x, y in loader:
            ...
            with torch.cuda.amp.autocast(dtype=ptdtype):  
                ...
                x_end_student_list, x_student, s_start_stage, x_student_start, codebook_loss, info = vq_model_s.module.decode_student(imgs, num_steps=1, cfg_scale=args.cfg_scale)
                x_end_teacher_list, start_stage, codebook_loss, info = vq_model_t.decode_teacher(imgs, s_start_stage, x_student_start, num_steps=1, cfg_scale=args.cfg_scale)
                ...
                # c = (1.0 / (u + 1)).to(device)
                c = 1.0
                student_aligned = x_end_student_list
                teacher_aligned = x_end_teacher_list[1:]
